...
// Replace k9_ex, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= k9_ex — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining k9_ex for
...
* Upstream: https://github.com/hyperpolymath/k9_ex/issues
