...
// Replace k9_ex, K9_Ex — See README.adoc for details., just run, K9_Ex started successfully. with actuals
= k9_ex — Quick Start for Users
:toc:
:toclevels: 2

== What is k9_ex?

K9_Ex — See README.adoc for details.
...
----
# Clone and set up
git clone https://github.com/hyperpolymath/k9_ex.git
cd k9_ex
just setup
----
...
[source,bash]
----
just install --portable --prefix=./k9_ex-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/k9_ex/wiki
