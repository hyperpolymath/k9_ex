...
Developers working *on* `k9_ex`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/k9_ex.git
cd k9_ex
...
* Bugs in `k9_ex`: file at `hyperpolymath/k9_ex/issues`.
